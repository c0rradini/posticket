...
<div class="container" style="margin-top: 15px;margin-bottom: 15px;">
    <div class="row">
        <div class="col-md-12" style="margin-top: 15px;">
            <p style="margin-bottom: 5px;font-size: 32px;font-weight: bold;">Editar Máquina</p>
        </div>
    </div>
    ...
    <form action="{{route('atualiza.maquina', ['id'=>$maquina->id])}}" method="POST">
        ...
        <div class="row">
            <div class="col-md-6" style="margin-top: 15px;">
                <p style="margin-bottom: 5px;margin-top: 5px;">Editar Maquina*</p>
            ...
            <div class="col-md-6" style="margin-top: 15px;">
                <p style="margin-bottom: 5px;margin-top: 5px;">Lista de máquinas já cadastrados:</p>
