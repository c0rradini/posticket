                    ...
                    <div class="modal-body text-start">
                        ...
                        <div class="col">
                            <!-- <form action="{{ route('atualiza.ticket', ['id'=>$ticket->id]) }}" method="POST">
                                ...
                                <textarea required class="form-control bg-light border rounded shadow-sm p-2 mb-4" style="width: 100%;min-height: 180px;height:80%;" name="obsLog" placeholder="Insira as observações necessárias" require value="{{ old('obsLog') }}"></textarea>
                        </div>
                    </div>
...
<div class="container row row-cols-2">
    ...
    <div class="col-md-6">
        ...
        <div class="col d-flex align-items-center mb-4">
            ...
            <select id="status" name="status" class="form-control bg-light border rounded shadow-sm p-2" style="margin-bottom:0px" required>

                <option value="{{ old('status', $ticket->status) }}" selected="@selected(old('$ticket->status'))">
                    @if( $ticket->status == '1')
                    Aberto
            ...
            <div class="modal-body text-start">
                ...
                <div class="col">
                    <form action="{{ route('ticket.encerrar-ticket', ['id'=>$ticket->id]) }}" method="POST">
                        ...
                        @method('PUT')
                        <p style="margin-bottom:0px;">Observações&nbsp;no&nbsp;Log:&nbsp;</p>
                        <textarea required class="form-control bg-light border rounded shadow-sm p-2 mb-4" style="width: 100%;min-height: 180px;height:80%;" name="obsLog" placeholder="Motivo de encerramento" require value="{{ old('obsLog') }}"></textarea>
